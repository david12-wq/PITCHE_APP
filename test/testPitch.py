...
class PitchModelTest(unittest.TestCase):
    def setUp(self):
        ...
        self.new_pitch = Pitch(id=1,pitch_title='Test',pitch_content='This is a test pitch',category="interview",user = self.user_David,likes=0,dislikes=0)
    ...
    def test_check_instance_variables(self):
        ...
        self.assertEquals(self.new_pitch.user,self.user_David)
